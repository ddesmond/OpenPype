...
class ContextReferenceLoader(load.LoaderPlugin):
    """Reference context file into Clarisse"""
    ...
    def load(self, context, name=None, namespace=None, data=None):
        ...
        imports_context = str(get_imports_context()) + "/contexts"
        ...
        namespace = "ctx_" + namespace + "_" + node_name
